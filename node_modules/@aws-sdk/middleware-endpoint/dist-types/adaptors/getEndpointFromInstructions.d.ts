...
import { EndpointResolvedConfig } from "@aws-sdk/middleware-endpoint/dist-types/resolveEndpointConfig";
import { EndpointParameterInstructions } from "@aws-sdk/middleware-endpoint/dist-types/types";
 ...
 */
export declare const getEndpointFromInstructions: <T extends EndpointParameters, CommandInput extends Record<string, unknown>, Config extends Record<string, unknown>>(commandInput: CommandInput, instructionsSupplier: EndpointParameterInstructionsSupplier, clientConfig: Partial<EndpointResolvedConfig<T>> & Config, context?: HandlerExecutionContext | undefined) => Promise<EndpointV2>;
