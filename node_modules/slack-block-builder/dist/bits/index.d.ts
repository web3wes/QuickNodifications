import { AttachmentBuilder, AttachmentParams } from 'slack-block-builder/dist/bits/attachment';
import { ConfirmationDialogBuilder, ConfirmationDialogParams } from 'slack-block-builder/dist/bits/confirmation-dialog';
import { OptionBuilder, OptionParams } from 'slack-block-builder/dist/bits/option';
import { OptionGroupBuilder, OptionGroupParams } from 'slack-block-builder/dist/bits/option-group';
 ...
 */
export declare function Attachment(params?: AttachmentParams): AttachmentBuilder;
/**
 * @param {Object} [params] Parameters passed to the constructor.
 ...
 */
export declare function ConfirmationDialog(params?: ConfirmationDialogParams): ConfirmationDialogBuilder;
/**
 * @param {Object} [params] Parameters passed to the constructor.
 ...
 */
export declare function Option(params?: OptionParams): OptionBuilder;
/**
 * @param {Object} [params] Parameters passed to the constructor.
 ...
 */
export declare function OptionGroup(params?: OptionGroupParams): OptionGroupBuilder;
declare const bits: {
