...
import type { SectionElementBuilder, Settable } from 'slack-block-builder/dist/internal/types';
import type { OptionBuilder } from 'slack-block-builder/dist/bits';
...
export declare abstract class InitialDate extends Builder {
    /**
     ...
     * {@link https://www.blockbuilder.dev|Open Block Builder Documentation}
     */
    initialDate(date: Settable<Date>): this;
}
...
export declare abstract class InitialUser extends Builder {
     ...
     * {@link https://www.blockbuilder.dev|Open Block Builder Documentation}
     */
    initialUser(userId: Settable<string>): this;
}
export declare abstract class InitialValue extends Builder {
    /**
     ...
     * {@link https://www.blockbuilder.dev|Open Block Builder Documentation}
     */
    initialValue(value: Settable<string>): this;
}
