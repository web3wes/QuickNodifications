import { SlackEvent, BasicSlackEvent } from '@slack/bolt/src/types/events/base-events';
import { StringIndexed } from '@slack/bolt/src/types/helpers';
import { SayFn } from '@slack/bolt/src/types/utilities';
export * from '@slack/bolt/src/types/events/base-events';
export { GenericMessageEvent, BotMessageEvent, ChannelArchiveMessageEvent, ChannelJoinMessageEvent, ChannelLeaveMessageEvent, ChannelNameMessageEvent, ChannelPostingPermissionsMessageEvent, ChannelPurposeMessageEvent, ChannelTopicMessageEvent, ChannelUnarchiveMessageEvent, EKMAccessDeniedMessageEvent, FileShareMessageEvent, MeMessageEvent, MessageChangedEvent, MessageDeletedEvent, MessageRepliedEvent, ThreadBroadcastMessageEvent, } from '@slack/bolt/src/types/events/message-events';
/**
 ...
 */
export declare type EventFromType<T extends string> = KnownEventFromType<T> extends never ? BasicSlackEvent<T> : KnownEventFromType<T>;
export declare type KnownEventFromType<T extends string> = Extract<SlackEvent, {
    type: T;
}>;
/**
